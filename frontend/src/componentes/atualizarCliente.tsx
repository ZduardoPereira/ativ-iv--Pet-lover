                                ...
                                <div className="card-content">
                                    <div className="row">
                                        ...
                                        <div className="input-field col s6">
                                            <p> Nome: </p>
                                            <input onChange={capturarNome} id="nome" type="text" className="validate active" maxLength={300} value={nome} required placeholder="Nome"/>
                                        </div>
                                    </div>    
                                        <div className="row">
                                        <div className="input-field col s6">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="input-field col s6">
                                            <p> Número: </p>
                                            <input onChange={capturarRuaNumero} id="ruaNumero" type="text" className="validate" maxLength={30} value={numero} required placeholder="Número" />
                                        </div>
                                        <div className="input-field col s6">
                                            <p> CEP: </p>
                                            <input onChange={capturarCodigoPostal} id="codigoPostal" type="text" className="validate" maxLength={30} value={codigoPostal} required placeholder="CEP" />
                                        </div>
                                        </div>
                                    <div className="row">
                                        <div className="input-field col s6">
                                            <p> Complemento: </p>
                                            <input onChange={capturarInfoAdicionais} id="informaçõesAdicionais" type="text" maxLength={255} value={informacoesAdicionais} required placeholder="complemento" />
                                        </div>
                                    </div>
                                </div>
                                <div className="card-action">
                                        <button className="btn waves-effect waves-light green accent-3" type="submit" name="action">Cadastrar
